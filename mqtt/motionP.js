...
client.on('message', (topic, message) => {
    ...
    console.log(`data 수집 시간 : ${now} Received message from topic ${topic}:`, data);
    console.log(`motionData 수집 시간 : ${now} Received message from topic ${topic}:`, motionData);
