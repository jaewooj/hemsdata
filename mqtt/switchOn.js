...
client.on('connect', () => {
  client.subscribe('zigbee2mqtt/0xa4c138bce829abd7'); // 스마트 플러그의 토픽
...
// client.publish('zigbee2mqtt/0xa4c138bce829abd7/set', JSON.stringify({"state_center": "on"}), () => {
// client.publish('zigbee2mqtt/0xa4c138bce829abd7/set', JSON.stringify({"state_right": "off"}), () => {
